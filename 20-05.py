#Напишите программу, которая ищет нули в таблице чисел и печатает True, если нули
#нашлись.
#В противном случае надо напечатать False.
#Эту задачу надо постараться решить «в одну строчку». В этом вам помогут функции
#any и all.
...
print(any(not all(map(int, x.split())) for x in chisla.split('\n')))
